...
local spidertron_mk2_animations = require("__spidertrontiers-circulardependency__.spidertron_animations.spidertron_mk2-animations")
...
local spidertron_mk2 = {
    ...
    minimap_representation = {
      	filename = "__spidertrontiers-circulardependency__/graphics/entity/spidertron_mk2/spidertron-map.png",
      	flags = {"icon"},
      	size = {128, 128},
      	scale = 0.5
    },
    ...
    guns = { "spidertron-mk2-rocket-launcher-1", "spidertron-mk2-rocket-launcher-2", "spidertron-mk2-rocket-launcher-3", "spidertron-mk2-rocket-launcher-4" },
    inventory_size = 100,
...
local spidertron_mk2_remnants = {
    ...
    animation = make_rotated_animation_variations_from_sheet (1,
    {
      	layers = {
        	{
	          	filename = "__spidertrontiers-circulardependency__/graphics/entity/spidertron_mk2/remnants/spidertron-remnants.png",
	          	line_length = 1,
	          	width = 224,
	          	height = 224,
	          	frame_count = 1,
	         	...
	         	shift = util.by_pixel(0, 0),
	          	r_version = {
		            filename = "__spidertrontiers-circulardependency__/graphics/entity/spidertron_mk2/remnants/hr-spidertron-remnants.png",
		            line_length = 1,
		            width = 448,
		            height = 448,
		            frame_count = 1,
        	...
        	{
	          	priority = "low",
	          	filename = "__spidertrontiers-circulardependency__/graphics/entity/spidertron_mk2/remnants/mask/spidertron-remnants-mask.png",
	          	width = 184,
	          	height = 176,
	          	frame_count = 1,
	         	-- tint = { r = 0.869, g = 0.5  , b = 0.130, a = 0.5 },
	          	...
	          	hr_version = {
		            priority = "low",
		            filename = "__spidertrontiers-circulardependency__/graphics/entity/spidertron_mk2/remnants/mask/hr-spidertron-remnants-mask.png",
		            width = 366,
		            height = 350,
		            frame_count = 1,
		            --tint = { r = 0.869, g = 0.5  , b = 0.130, a = 0.5 },
...
data:extend{
	...
	utils.make_spidertron_leg("spidertron-mk2", 1, 0.06, 0.04, 1, 1, spidertron_mk2_animations),
	utils.make_spidertron_leg("spidertron-mk2", 1, 0.06, 0.04, 1, 2, spidertron_mk2_animations),
	utils.make_spidertron_leg("spidertron-mk2", 1, 0.06, 0.04, 1, 3, spidertron_mk2_animations),
	utils.make_spidertron_leg("spidertron-mk2", 1, 0.06, 0.04, 1, 4, spidertron_mk2_animations),
	utils.make_spidertron_leg("spidertron-mk2", 1, 0.06, 0.04, 1, 5, spidertron_mk2_animations),
	utils.make_spidertron_leg("spidertron-mk2", 1, 0.06, 0.04, 1, 6, spidertron_mk2_animations),
	utils.make_spidertron_leg("spidertron-mk2", 1, 0.06, 0.04, 1, 7, spidertron_mk2_animations),
	utils.make_spidertron_leg("spidertron-mk2", 1, 0.06, 0.04, 1, 8, spidertron_mk2_animations),
}
