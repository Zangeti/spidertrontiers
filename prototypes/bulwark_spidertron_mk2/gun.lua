...
local bulwark_spidertron_mk2_machine_gun_1 = {
    type = "gun",
    name = "bulwark-spidertron-mk2-machine-gun-1",
	localised_name = "Bulwark Spidertron Mk2 Machine Gun",
...
data:extend{
	...
	bulwark_spidertron_mk2_machine_gun_1,
}