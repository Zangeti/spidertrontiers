...
local voyage_spidertron_mk2_animations = require("__spidertrontiers__.spidertron_animations.voyage_spidertron_mk2-animations")
...
local voyage_spidertron_mk2 = {
    ...
    icon = "__spidertrontiers__/graphics/icons/voyage_spidertron_mk2.png",
    ...
    minimap_representation = {
      	filename = "__spidertrontiers__/graphics/entity/voyage_spidertron_mk2/spidertron-map.png",
      	flags = {"icon"},
      	size = {128, 128},
      	scale = 0.5
    },
    ...
    chain_shooting_cooldown_modifier = 1.2, --modified
    spider_engine = {
      	legs = {
	        { -- 1
...
local voyage_spidertron_mk2_remnants = {
    ...
    animation = make_rotated_animation_variations_from_sheet (1,
    {
      	layers = {
        	{
	          	filename = "__spidertrontiers__/graphics/entity/voyage_spidertron_mk2/remnants/spidertron-remnants.png",
	          	line_length = 1,
	          	width = 224,
	          	height = 224,
	          	frame_count = 1,
	         	...
	         	shift = util.by_pixel(0, 0),
	          	r_version = {
		            filename = "__spidertrontiers__/graphics/entity/voyage_spidertron_mk2/remnants/hr-spidertron-remnants.png",
		            line_length = 1,
		            width = 448,
		            height = 448,
		            frame_count = 1,
        	...
        	{
	          	priority = "low",
	          	filename = "__spidertrontiers__/graphics/entity/voyage_spidertron_mk2/remnants/mask/spidertron-remnants-mask.png",
	          	width = 184,
	          	height = 176,
	          	frame_count = 1,
	         	-- tint = { r = 0.869, g = 0.5  , b = 0.130, a = 0.5 },
	          	...
	          	hr_version = {
		            priority = "low",
		            filename = "__spidertrontiers__/graphics/entity/voyage_spidertron_mk2/remnants/mask/hr-spidertron-remnants-mask.png",
		            width = 366,
		            height = 350,
		            frame_count = 1,
		            --tint = { r = 0.869, g = 0.5  , b = 0.130, a = 0.5 },
...
data:extend{
	...
	make_voyage_spidertron_mk2_leg(1),
	make_voyage_spidertron_mk2_leg(2),
	make_voyage_spidertron_mk2_leg(3),
	make_voyage_spidertron_mk2_leg(4),
	make_voyage_spidertron_mk2_leg(5),
	make_voyage_spidertron_mk2_leg(6),
	make_voyage_spidertron_mk2_leg(7),
	make_voyage_spidertron_mk2_leg(8),
	make_voyage_spidertron_mk2_leg(9),
	make_voyage_spidertron_mk2_leg(10),
}
